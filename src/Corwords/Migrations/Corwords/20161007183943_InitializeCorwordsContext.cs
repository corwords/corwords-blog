...
{
    public partial class InitializeCorwordsContext : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MediaObjects", x => x.MediaObjectId);
                });

            migrationBuilder.CreateTable(
                name: "MediaObjectInfos",
                columns: table => new
                {
                    MediaObjectInfoId = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    Url = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_MediaObjectInfos", x => x.MediaObjectInfoId);
                });
